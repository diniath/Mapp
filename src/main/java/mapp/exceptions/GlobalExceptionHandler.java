...
import mapp.web.ApiError;
import mapp.web.ResponseEntityBuilder;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleResourceNotFoundException(ResourceNotFoundException ex) {
		...
		ApiError err = new ApiError(LocalDateTime.now(),HttpStatus.NOT_FOUND, "Resource Not Found MERRY CHRISTMAS HAHAHAAH" ,details);
	...
	public ResponseEntity<Object> handleAll(Exception ex, WebRequest request) {
		...
		ApiError err = new ApiError(LocalDateTime.now(),HttpStatus.BAD_REQUEST, "Error occurred. !!! WE LOVE ERRORS !!! " ,details);
